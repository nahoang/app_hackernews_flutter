...
class MyDatabase extends _$MyDatabase {
  ...
  void addFavorite(Article article) {
    var favorite = Favorite(id: article.id, url: article.url, title: article.title, category: article.type);
    into(favorites).insert(favorite);
  }

  void removeFavorite(int i) => (delete(favorites)..where((t) => t.id.equals(i))).go();
